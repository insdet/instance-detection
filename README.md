...
### Demo
The Jupyter notebooks files demonstrate our ono-learned method using SAM and DINOv2. The pretrained models for SAM and DINOv2 are downloaded from their github homepages.
|                  | SAM  | DINOv2|
| :---             | :---:|:---:|
| Pretrained Model | | |
